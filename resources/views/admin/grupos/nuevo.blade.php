              ...
              <div class="panel-body">
                 ...
                 <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="panel-title"><b>Crear Nuevo grupo</b>
                      </div>
                    ...
                    <div class="panel-body">
                      ...
                      @error('codigo')
                        ...
                        <strong>ERROR</strong>  Este codigo ya esta Guardado o
                          almenos debe contener  4 caracter 
                      </div>                            
                      @enderror
                              @error('nombre')
                           <div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <strong>ERROR</strong>  Este nombre ya esta Guardado o
                          almenos debe contener  4 caracter 
                      </div>                            
                      @enderror
